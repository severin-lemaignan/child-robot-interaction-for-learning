...
\date{{\bf  BrisTech} -- 05 Sept 2019}
\author{Séverin Lemaignan \texttt{\small @skadge}}
...
\imageframe[color=black]{cellulo/balldrive-cellulo-model}

\videoframe[0.56]{figs/cellulo/cellulo.mp4}
...
\imageframe[color=black, caption=Social support beyond learning]{couch25k/supervised}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     \begin{center}
         \resizebox{\linewidth}{!}{
             \begin{tikzpicture}[stop jumping, >=latex]
                 \node[double arrow,draw] (spec) {Interaction spectrum};
                 \node<1->[minimum size=3cm,left=of spec] {\includegraphics[width=5cm]{cellulo/haptic.jpg}};
                 \node<1->[minimum size=3cm,right=of spec] {\includegraphics[width=5cm]{sparc/foodchain-game.jpg}};
                 \node<2>[minimum size=1cm,above=of spec]{\includegraphics[height=5cm]{robot4SEN/child-pepper.png}};
             \end{tikzpicture}
         }
     \end{center}
    }
...
\begin{frame}{In conclusion}
    ...
    \begin{itemize}
        \item<+-> Not only 'child-robot interaction for learning', but also
            'classroom-robot interaction' (importance of \emph{orchestration})
        ...
        \item<+-> And \emph{do not to forget to also try new things!}
    \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}[plain]
    ...
    \centering
    \large
    And don't loose the focus:
    \bf

    robots to support rich \& fun human-human interactions!
...
\begin{frame}[plain]
    ...
    \begin{columns}
        ...
        \includegraphics[width=0.3\linewidth]{katie}
...
%}
 ...
 \begin{frame}[plain]{}
    ...
    Most of our social abilities build on sub-conscious social
    behaviours:
...
\begin{frame}[plain]
    \begin{center}
    \Large\bf
        Can we turn it into a rigorous research methodology?
    \end{center}
\end{frame}

%\imageframe[color=black, scale=0.9]{freeplay/sandbox}

\begin{frame}{Appropriate social situation?}

    ...a situation/activity that exhibits:
    ...
    \begin{itemize}
        ...
        \item clear quantitative \& qualitative metrics
        \item practical!
    \end{itemize}
\end{frame}
