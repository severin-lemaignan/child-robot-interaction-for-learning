...
%--------------------------------------------------------------------------
\title{learning \& child-robot interaction}
\subtitle{a glimpse into the next challenges}
\date{{\bf  Symposium on Robots for Language Learning} -- 13 Dec. 2018}
...
\begin{frame}[plain]
    ...
    Getting our robots accepted \& used in schools, without us being
    around...?
\end{frame}

\imageframe[color=black,caption={Classrooms are scary!}]{robots-classroom}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \begin{frame}{Why that?}
     ...
     \begin{itemize}
         ...
         \item<3-> {\bf practical}: to gain broad
...
\begin{frame}[plain]
    \Large\bf\centering
%Do we need social robots at all?
...
\begin{frame}[plain]
    ...
    classroom, how to address the \textbf{tension between robot autonomy and teacher
    control}?
...
\begin{frame}{What does that means for the teacher?}
    ...
    \begin{columns}
        ...
        \begin{column}{0.55\linewidth}
            \only<1>{
            \begin{itemize}
                \item {\bf Progressively transferring autonomy} is a general
                    principle; it demonstrably works in non-trivial tutoring
                    scenarios
            ...
            \begin{itemize}
                ...
                \item because the training takes place in-situ, the
                    robot behaviours are \textbf{co-constructed} with the
...
\begin{frame}{What role does the robot play here?}
    \begin{itemize}
        \item<1-> Not a 'tool to teach robotics', not a facilitator/tutor
...
\begin{frame}{A lot has been achieved in that field already}
...
\section[Data-driven!]{Towards the data-driven study child-robot interactions?}
...
\begin{frame}{What does that mean for child-robot interaction?}
        ...
        \begin{column}{0.6\linewidth}
            ...
            \begin{itemize}
                ...
                \item<+-> The robot needs to learn to recognise and interpret
                    ...
                    real-time!)
                \item<+-> We start to have raw material. We still need to
                    process it.
            \end{itemize}
        }
            \only<5-> {
