...
interplay~of~socio-cognitive~functions}]{robots-classroom}
 ...
 \begin{frame}{Why that?}
     ...
     \begin{itemize}
         ...
         \item<2-> {\bf versatile}: applicable to a broad range of learning
             scenarios; the good tool is not overly specialised (appearance and
             interaction modalities do not imply or force a specific/unique use
             case)

         \item<3-> {\bf practical}: to gain field
             acceptance in the classrooms, a tool must critically
...
\section[Social robots?]{Do we need social robots at all?}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \imageframe[caption=Cellulo]{cellulo/classroom-withcellulo}
...
\section{The challenge of ``doing together''}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
